...
class EPNuevaTarjetaPage extends StatefulWidget {
  ...
  @override
  _EPNuevaTarjetaPageState createState() => _EPNuevaTarjetaPageState();
}

class _EPNuevaTarjetaPageState extends State<EPNuevaTarjetaPage> {
  PromotionModel pro;
  PlanModel plan;
  ...
  Future<void> _crearTarjeta(CulqiCard card) async {
    ...
    if(response.statusCode == 200) {
      ...
      showMessage(context, "Se ha producido un error registrando la tarjeta");
    }
  ...
  Future<void> showMessage(BuildContext context, String error) async {
    Navigator.of(context, rootNavigator: true).pop();
    return showDialog(
        context: context,
        barrierColor: Colors.black.withOpacity(0.3),
