...
class VideoAgenda extends StatefulWidget {
  ...
  @override
  _VideoAgendaState createState() => _VideoAgendaState();
}

class _VideoAgendaState extends State<VideoAgenda> {
            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                  ...
                  children: [
                    Text('Monto de la videoconsulta ',
                        style: TextStyle(
                            fontSize: 17,
                            color: Color(0xFF57419D),
                            fontWeight: FontWeight.bold),
                    ...
                    Row(
                      children: [
                        ...
                        // Checkbox(value: _value2, activeColor: Color(0xFF5B618F), onChanged: (bool value){
                        //   setState(() {
                        //     _value2 = value;
                        //     if(value==true){
                ...
                PetshopApp.pasarelaDisponible()
                    ? Row(
                        ...
                        children: [
                          ...
                          // Row(
                          //   children: [
                          //     Text("\$", style: TextStyle(color: Color(0xFF5B618F), fontSize: 22, fontWeight: FontWeight.bold,),),
                          //     Text((widget.serviceModel.precio+recojo+delivery).toString(), style: TextStyle(color: Color(0xFF5B618F), fontSize: 22, fontWeight: FontWeight.bold,),),
                          //   ],
                          // ),
                        ],
                      )
  ...
  //                 //       crossAxisAlignment: CrossAxisAlignment.start,
  //                 //       children: [
  //                 //         Text('Items', style: TextStyle(color: Color(0xFF5B618F), fontWeight: FontWeight.bold, fontSize: 12),),
  //                 //         SizedBox(height: 10,),
  //                 //         Row(
  //                 //           children: [
  //                 //
